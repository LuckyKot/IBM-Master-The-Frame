...
def luhn(card_number):
    ...
    return (checksum % 10)
#luhn algorithm check, returns 0 for valid inputs - anything but 0 for invalid ones
...
for cc_line in cc_list:                 # do everything here for every item in that List
    ...
    if (luhn(cc_digits)!=0):            # If the card number is valid
        invalid_cc_list.append(cc_line)
#puts all invalid ones in a list
